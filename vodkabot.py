...
def NOTIFIED_ADD_CONTACT(op):
    try:
        sendMessage(op.param1, client.getContact(op.param1).displayName + "Ba Tashkor Babat Add Kardan Mn Golam Bot... line.me/R/ti/p/%40nlr3381q")
...
def NOTIFIED_ACCEPT_GROUP_INVITATION(op):
    #print op
    try:
        sendMessage(op.param1, client.getContact(op.param2).displayName + "Salam Khosh Omadi Be Group Golam :) Nochat Add Me line.me/R/ti/p/%40nlr3381q " + group.name)
    except Exception as e:
        print e
    ...
    try:
        if msg.toType == 0:
            if msg.contentType == 0:
                ...
                if msg.text == "gift":
                    sendMessage(msg.to, texth"ttp://line.me/R/shop/detail/1635361", contentMetadata=None, contentType=9)
                else:
                    pass
            else:
                pass
            ...
            if msg.contentType == 0:
                ...
                if msg.text == "Batalkan":
                    ...
                    if group.invitee is None:
                        ...
                        sendMessage(msg.to, str(len(group.invitee)) + "Add my Account  line.me/R/ti/p/%40nlr3381q")

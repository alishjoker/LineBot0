...
def NOTIFIED_ADD_CONTACT(op):
    try:
        sendMessage(op.param1, client.getContact(op.param1).displayName + "salam Mrc Babat Add Mn :) Add Me http://line.me/R/ti/p/%40nlr3381q")
